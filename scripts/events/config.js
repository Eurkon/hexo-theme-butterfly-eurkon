...
hexo.extend.filter.register('before_generate', () => {
  ...
  const defaultCDN = {
    ...
    sharejs: 'https://fastly.jsdelivr.net/npm/social-share.js/dist/js/social-share.min.js',
    ...
    instantpage: 'https://fastly.jsdelivr.net/npm/instant.page/instantpage.min.js',
    typed: 'https://fastly.jsdelivr.net/npm/typed.js/lib/typed.min.js',
    pangu: 'https://fastly.jsdelivr.net/npm/pangu/dist/browser/pangu.min.js',
    ...
    // aplayer
    aplayer_css: 'https://fastly.jsdelivr.net/npm/aplayer/dist/APlayer.min.css',
    aplayer_js: 'https://fastly.jsdelivr.net/npm/aplayer/dist/APlayer.min.js',
    meting_js: 'https://fastly.jsdelivr.net/gh/metowolf/MetingJS@1.2/dist/Meting.min.js',

    // Prism.js
    prismjs_js: 'https://fastly.jsdelivr.net/npm/prismjs/prism.min.js',
    prismjs_lineNumber_js: 'https://fastly.jsdelivr.net/npm/prismjs/plugins/line-numbers/prism-line-numbers.min.js',
    prismjs_autoloader: 'https://fastly.jsdelivr.net/npm/prismjs/plugins/autoloader/prism-autoloader.min.js'
  }
